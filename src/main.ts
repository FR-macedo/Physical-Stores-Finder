...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    ...
    .addTag('shipping', 'Endpoints relacionados a cálculos de frete')
    .addBearerAuth()
  ...
  document.paths = Object.entries(document.paths).reduce((acc, [path, methods]) => {
              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    code: { type: 'string', example: 'STORE_VALIDATION_ERROR' },
                    message: { type: 'string', example: 'CEP inválido' },
                    details: { type: 'object', example: { cep: '12345' } },
                    timestamp: { type: 'string', example: '2024-04-14T12:00:00.000Z' },
              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    message: { type: 'string', example: 'Loja não encontrada' },
              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    message: { type: 'string', example: 'Já existe uma loja com este nome' },
                    details: { type: 'object', example: { storeName: 'Loja Teste' } },
                    timestamp: { type: 'string', example: '2024-04-14T12:00:00.000Z' },
              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    details: { type: 'object', example: { error: 'Database connection failed' } },
                    timestamp: { type: 'string', example: '2024-04-14T12:00:00.000Z' },
                    path: { type: 'string', example: '/api/stores' },
                  },
                },
  ...
  Logger.log(`Documentação Swagger disponível em http://localhost:${port}/docs`, 'Bootstrap');
}
